...
LANGUAGE RULE: Detect the language of the QUESTION and respond entirely in that same language. If the question is in Arabic, write your complete response in Arabic. If the question is in English, write in English. Never mix languages in your response."""
